...
export default class ApiService {
  ...
  static BASE_URL = "http://3.110.189.210:8080";
  ...
  /* Gets all availavle by dates rooms from the database with a given date and a room type */
  ...
  /* All room types from the database */
  ...
  /* Booking by the cnfirmation code */
